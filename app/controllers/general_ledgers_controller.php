...
class GeneralLedgersController extends AppController {
    ...
    function indexByTb($chart_account_id = null, $dateAsOf = null, $companyId = null, $customerId = null, $vendorId = null, $otherId = null, $classId = null) {
        $this->layout = 'ajax';
    ...
    function ajaxByTb($chart_account_id = null, $dateAsOf = null, $companyId = null, $customerId = null, $vendorId = null, $otherId = null, $classId = null, $filterDateFrom = null, $filterDateTo = null, $filterStatus = null, $filterCreatedBy = null) {
        $this->layout = 'ajax';
        $this->set('chart_account_id', $chart_account_id);
        $this->set('dateAsOf', $dateAsOf);
        $this->set('companyId', $companyId);
    ...
    function indexByGroup($chart_account_group_id = null, $dateAsOf = null, $companyId = null, $customerId = null, $vendorId = null, $otherId = null, $classId = null) {
        $this->layout = 'ajax';
    ...
    function ajaxByGroup($chart_account_group_id = null, $dateAsOf = null, $companyId = null, $customerId = null, $vendorId = null, $otherId = null, $classId = null, $filterDateFrom = null, $filterDateTo = null, $filterStatus = null, $filterCreatedBy = null) {
        $this->layout = 'ajax';
        $this->set('chart_account_group_id', $chart_account_group_id);
        $this->set('dateAsOf', $dateAsOf);
        $this->set('companyId', $companyId);
    ...
    function indexByGroupDateRange($chart_account_group_id = null, $dateFrom = null, $dateTo = null, $companyId = null, $customerId = null, $vendorId = null, $otherId = null, $classId = null) {
        $this->layout = 'ajax';
        $this->set('chart_account_group_id', $chart_account_group_id);
        $this->set('dateFrom', $dateFrom);
        $this->set('dateTo', $dateTo);
    ...
    function ajaxByGroupDateRange($chart_account_group_id = null, $dateFrom = null, $dateTo = null, $companyId = null, $customerId = null, $vendorId = null, $otherId = null, $classId = null, $filterDateFrom = null, $filterDateTo = null, $filterStatus = null, $filterCreatedBy = null) {
        $this->layout = 'ajax';
        $this->set('chart_account_group_id', $chart_account_group_id);
        $this->set('dateFrom', $dateFrom);
        $this->set('dateTo', $dateTo);
            ...
            if ($this->GeneralLedger->save($this->data)) {
                ...
                for ($i = 0; $i < sizeof($_POST['chart_account_id']); $i++) {
                    if ($_POST['chart_account_id'][$i] != '') {
                        $this->GeneralLedgerDetail->create();
                        $GeneralLedgerDetail['GeneralLedgerDetail']['general_ledger_id'] = $generalLedgerId;
                        $GeneralLedgerDetail['GeneralLedgerDetail']['company_id'] = $_POST['company_id'][$i];
                        $GeneralLedgerDetail['GeneralLedgerDetail']['chart_account_id'] = $_POST['chart_account_id'][$i];
                        $GeneralLedgerDetail['GeneralLedgerDetail']['type'] = 'General Journal';
                        $GeneralLedgerDetail['GeneralLedgerDetail']['debit'] = $_POST['debit'][$i];
                        $GeneralLedgerDetail['GeneralLedgerDetail']['credit'] = $_POST['credit'][$i];
