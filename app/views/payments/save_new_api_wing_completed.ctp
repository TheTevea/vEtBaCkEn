        ...
        <div style="width: 100%; text-align: center;" id="content-sms">
            ...
            <table style="width: 100%; text-align: left;" cellspacing="5" cellpadding="5">
                ...
                <tr style="padding-top: 10px;">
                    <td colspan="2" style="font-size: 14px;">Transaction ID: <?php echo $rowChk['code']; ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="border-top: #000 dotted; padding-top: 10px; font-size: 14px;">Lucky Ticket: </td>
                    <td style="text-align: right;border-top: #000 dotted; padding-top: 10px; font-size: 14px;"><?php echo number_format($rowChk['lucky_draw_fee'], 2); ?> USD</td>
                </tr>
                <tr style="padding-top: 10px;">
                    <td style="border-top: #000 dotted; padding-top: 10px; font-size: 20px; font-weight: bold;">TOTAL: </td>
                    <td style="text-align: right;border-top: #000 dotted; padding-top: 10px; font-size: 20px; font-weight: bold;"><?php echo number_format((($rowChk['total_amount'] + $rowChk['total_vat']) - $rowChk['discount_amount'] + $rowChk['lucky_draw_fee']), 2); ?> USD</td>
                </tr>
            </table>
        </div>
    </div>
