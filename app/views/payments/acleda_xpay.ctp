...
<html lang="en">
    ...
    <body>
        ...
        $html = '<form id="_xpayTestForm" name="_xpayTestForm" action="'.$response['url'].'" method="post">
            ...
            <input type="hidden" id="successUrlToReturn" name="successUrlToReturn" value="'.$response['url_success'].$response['transactionID']."/".$response['token'].'">
            <input type="hidden" id="errorUrl" name="errorUrl" value="'.$response['url_cancel'].$response['paymenttokenid'].'"> 
