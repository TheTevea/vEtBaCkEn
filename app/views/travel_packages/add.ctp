...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#TravelPackagePrice").autoNumeric({mDec: 2, aSep: ','});
        $("#TravelPackagePeriodExpired").autoNumeric({mDec: 0, aSep: ','});
        
        $("#TravelPackageAddForm").validationEngine('attach', {
            isOverflown: true,
            overflownDIV: ".ui-tabs-panel"
        });
        $("#TravelPackageAddForm").ajaxForm({
...
<?php echo $this->Form->create('TravelPackage'); ?>
...
<fieldset style="width: 47%; float: left; height: 1450px;">
    ...
    <table style="width: 100%;">
        <tr>
            <td colspan="2">
                <table>
                    <tr>
                        <td>
                            <input type="hidden" name="data[TravelPackage][photo]" id="TravelPackagePhoto" />
                            <img alt="" id="TravelPackagePhotoDisplay" style="width: 150px; height: 100px;" />
                        </td>
                    </tr>
                    <tr>
                        <td>
        ...
        <tr>
            ...
            <td>
                <div class="inputContainer">
                    <?php echo $this->Form->text('discount', array('class'=>'validate[required]', 'value' => 0)); ?> $
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <div class="inputContainer">
                    <?php echo $this->Form->text('period_expired', array('class'=>'validate[required]')); ?> Months
                </div>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <div class="inputContainer">
                    <?php echo $this->Form->text('buva_sea', array('class'=>'validate[required]', 'maxlength' => '4')); ?> %
                </div>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <div class="inputContainer">
                    <?php echo $this->Form->text('international_thai', array('class'=>'validate[required]', 'maxlength' => '4')); ?> %
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <div class="inputContainer">
                    <?php echo $this->Form->text('international_viet', array('class'=>'validate[required]', 'maxlength' => '4')); ?> %
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <div class="inputContainer">
                    <?php echo $this->Form->text('international_laos', array('class'=>'validate[required]', 'maxlength' => '4')); ?> %
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <div class="inputContainer">
                    <?php echo $this->Form->text('local', array('class'=>'validate[required]', 'maxlength' => '4')); ?> %
                </div>
            </td>
        </tr>
    </table>
