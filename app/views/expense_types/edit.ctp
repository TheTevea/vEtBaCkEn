...
<script type="text/javascript">
    $(document).ready(function(){
        // Prevent Key Enter
        preventKeyEnter();
        $("#ExpenseTypeEditForm").validationEngine('attach', {
            isOverflown: true,
            overflownDIV: ".ui-tabs-panel"
        });
        $("#ExpenseTypeEditForm").ajaxForm({
...
<input type="hidden" name="data[ExpenseType][sys_code]" value="<?php echo $this->data['ExpenseType']['sys_code']; ?>" />
<fieldset>
    <legend><?php __(MENU_EXPENSE_TYPE_INFO); ?></legend>
    <table>
        <tr>
            <td><label for="ExpenseTypeName"><?php echo TABLE_NAME; ?> <span class="red">*</span> :</label></td>
            <td>
