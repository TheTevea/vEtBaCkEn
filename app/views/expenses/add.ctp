        ...
        <tr>
            ...
            <td style="width: 20%;">
                <div class="inputContainer" style="width: 100%;">
                    <?php echo $this->Form->text('date', array('class'=>'validate[required]', 'readonly' => TRUE, 'style' => 'width: 90%;', 'value' => date("d/m/Y"))); ?>
                </div>
            </td>
            <td style="vertical-align: top;" rowspan="2"><label for="ExpenseNote"><?php echo TABLE_NOTE; ?> :</label></td>
            <td style="vertical-align: top;" rowspan="2">
                <div class="inputContainer" style="width: 100%;">
                    <?php echo $this->Form->input('note', array('style' => 'width: 90%; height: 40px;', 'label' => false)); ?>
                </div>
            </td>
        </tr>
        <tr>
    ...
    <div style="float: right; width:30%; display: none;">
        <table style="width: 100%;">
            <tr>
                ...
                <td>
                    <div class="inputContainer" style="width: 100%">
                        <?php echo $this->Form->text('total_amount', array('readonly' => true, 'class' => 'float validate[required]', 'style' => 'width: 200px; font-size:12px; font-weight: bold', 'value'=>'0.00')); ?> 
                    </div>
                </td>
            </tr>
        </table>
