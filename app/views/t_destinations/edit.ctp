    ...
    $(document).ready(function(){
        ...
        $("#<?php echo $frmName; ?>").ajaxForm({
            ...
            success: function(result) {
                ...
                $("#photoDisplayTDestination").attr("src", "<?php echo $this->webroot; ?>" + photoFolder + result);
...
<form id="<?php echo $frmName; ?>" action="<?php echo $this->base; ?>/t_destinations/upload/" method="post" enctype="multipart/form-data">
    <table style="width: 100%">
        <tr>
            <td style="width: 7%;"><label for="TDestinationPhoto"><?php echo TABLE_PHOTO; ?>:</label></td>
        ...
        <tr>
            <td colspan="2" style="text-align: left;">
                ...
                if($this->data['TDestination']['photo'] != ''){
                    $photo = "public/destination_photo/".$this->data['TDestination']['photo'];
                }else{
                    $photo = "img/button/no-images.png";
                }
                ?>
                <img id="photoDisplayTDestination" alt="" src="<?php echo $this->webroot; ?><?php echo $photo; ?>" style=" max-width: 140px; max-height: 140px;" />
            </td>
        </tr>
    </table>
</form>
<br />
<?php 
echo $this->Form->create('TDestination');
echo $this->Form->input('id'); 
echo $this->Form->hidden('sys_code');
?>
<input type="hidden" id="<?php echo $photoNameHidden; ?>" name="data[TDestination][new_photo]" />
<input type="hidden" id="TDestinationPhotoOld" name="data[TDestination][old_photo]" value="<?php echo $this->data['TDestination']['photo']; ?>" />
<fieldset style="width: 47%; float: left; height: 237px;">
    <legend><?php __(MENU_EDIT_DESTINATION_INFO); ?></legend>
    <table>
        <tr>
        ...
        <tr>
            <td><label for="TDestinationName"><?php echo TABLE_NAME; ?> <span class="red">*</span> :</label></td>
            <td>
                <div class="inputContainer">
    ...
    <table>
        ...
        <tr>
            ...
            <td style="vertical-align: top;">
                ...
                <select id="TDestinationAvbSelected" name="data[TDestination][t_destination_to_id][]" multiple="multiple" style="width: 300px; height: 200px;">
                <!-- <select id="TDestinationAvbSelected" multiple="multiple" style="width: 300px; height: 200px;"> -->
                    <?php
