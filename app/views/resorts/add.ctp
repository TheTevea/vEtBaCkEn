...
$link .= str_replace("/resorts/add/","/public/resort/",$_SERVER['REQUEST_URI']);
?>
<script type="text/javascript">
    ...
    $(document).ready(function(){
        // Prevent Key Enter
        preventKeyEnter();
        $("#ResortAddForm").validationEngine('attach', {
            isOverflown: true,
            overflownDIV: ".ui-tabs-panel"
        });
        $("#ResortAddForm").ajaxForm({
        ...
        <tr>
            <td colspan="2">
                <table>
                    <tr>
                        <td>
                            <input type="hidden" name="data[Resort][photo]" id="ResortPhoto" />
                            <img alt="" id="ResortPhotoDisplay" style="width: 150px; height: 100px;" />
                        </td>
                    </tr>
                    <tr>
                        <td>
