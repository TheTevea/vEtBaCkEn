...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#<?php echo $btnSearch; ?>").click(function(){
            ...
            var branch     = $("#<?php echo $mainBranch; ?>").val();
            if(((dateFrom != "" && dateTo != "") || (travelFrom != "" && travelTo != "")) && branch != ""){
                $("#<?php echo $divWarn; ?>").hide();
                $.ajax({
                    type: "POST",
                    url: "<?php echo $this->base; ?>/<?php echo $this->params['controller']; ?>/salesTicketResult",
...
<div style="width: 99%; margin: 0px auto; height: 800px; background: #fff; position: relative;">
    <form id="<?php echo $frmName; ?>" action="" method="post" style="width: 100%; ">
        <div class="legend" style="border-bottom: 1px solid #274a60; width: 100%;" id="headReport">
            ...
            <div class="legend_content <?php echo $formFilter; ?>" style="border: none;">
                <table style="width: 100%;">
                    <tr>
                        <td style="width: 90px;"><label for="<?php echo $mainBranch; ?>" style="font-size: 14px;"><?php echo 'សាខា'; ?>:</label></td>
                        <td>
                            <div class="inputContainer">
                                <?php 
                                $empty = false;
                                ...
                                echo $this->Form->select($mainBranch, $mainBranches, null, array('escape' => false, 'name' => 'branch', 'empty' => $empty, 'style' => 'height: 40px; width: 270px')); ?>
                            </div>
                        </td>
                    </tr>
                    <tr>
    ...
    <div id="<?php echo $divWarn; ?>" style="font-size: 14px; text-align: center; color: red; padding-top: 10px; display: none;">សូមជ្រើសរើស ថ្ងៃខែនឹងសាខា</div>
