...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#<?php echo $btnSearch; ?>").click(function(){
            ...
            if(dateFrom != "" && dateTo != "" && agency != ""){
                $("#<?php echo $divWarn; ?>").hide();
                $.ajax({
                    type: "POST",
                    url: "<?php echo $this->base; ?>/<?php echo $this->params['controller']; ?>/ticketBalanceResult/<?php echo $userId; ?>",
...
<div style="width: 99%; margin: 0px auto; height: 800px; background: #fff; position: relative;">
        ...
        <div class="legend" style="border-bottom: 1px solid #274a60; width: 100%;" id="headReport">
            <div class="legend_content <?php echo $formFilter; ?>" style="border: none;">
                <table style="width: 100%;">
                    <tr>
                        <td style="width: 90px;"><label for="<?php echo $dateFrom; ?>" style="font-size: 14px;"><?php echo 'កាលបរិច្ឆទ'; ?>:</label></td>
    ...
    <div id="<?php echo $divWarn; ?>" style="font-size: 14px; text-align: center; color: red; padding-top: 10px; display: none;">សូមជ្រើសរើស ថ្ងៃខែនឹងភ្នាក់ងារ</div>
