...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#PromotionApplyPackageEditForm").validationEngine('attach', {
            isOverflown: true,
            overflownDIV: ".ui-tabs-panel"
        });
        $("#PromotionApplyPackageEditForm").ajaxForm({
...
<input type="hidden" name="data[PromotionApplyPackage][id]" value="<?php echo $this->data['TravelPackageOrder']['id']; ?>" />
                ...
                <table>
                    <tr>
                        <td>
                            ...
                            <img src="<?php echo $img; ?>" id="PromotionApplyPackagePhotoDisplay" style="width: 150px; height: 100px;" />
                        </td>
                    </tr>
                    <tr>
                        <td>
            ...
            <td>
                <div class="inputContainer">
                    <select name="data[PromotionApplyPackage][nationality]" id="PromotionApplyPackageNationality" style="width: 180px;" class="validate[required]">
                        ...
                        ?>
                        <option value="<?php echo $rowNation['id']; ?>" <?php if($this->data['TravelPackageOrder']['nationality'] == $rowNation['id']){ ?>selected=""<?php } ?>><?php echo $rowNation['name']; ?></option>
                        <?php
                        }
                        ?>
                    </select>
        ...
        <tr>
            ...
            <td>
                <div class="inputContainer">
                    ...
                    $telSymbolRqu  = "";
                    $passSymbolRqu = "";
                    if($this->data['TravelPackageOrder']['nationality'] != 36){
                        $passRequired  = "validate[required]";
                        $passSymbolRqu = "*";
                    } else {
                        $telRequired  = "validate[required]";
                        $telSymbolRqu = "*";
                    }
                    echo $this->Form->text('name', array('class'=>'validate[required]', 'value' => $this->data['TravelPackageOrder']['name'])); ?>
                </div>
            </td>
        </tr>
        <tr>
            <td><label for="PromotionApplyPackageTelephone"><?php echo TABLE_TELEPHONE; ?> <span class="red requiredSymbolTel"><?php echo $telSymbolRqu; ?></span> :</label></td>
            <td>
                <div class="inputContainer">
                    <?php 
                    echo $this->Form->text('telephone', array('class'=>$telRequired, 'value' => $this->data['TravelPackageOrder']['telephone'])); 
                    ?>
                </div>
            </td>
        </tr>
        <tr>
            <td><label for="PromotionApplyPackagePassport"><?php echo TABLE_PASSPORT; ?> <span class="red requiredSymbolPass"><?php echo $passSymbolRqu; ?></span> :</label></td>
            <td>
                <div class="inputContainer">
                    <?php echo $this->Form->text('passport', array('class' => $passRequired)); ?>
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <div class="inputContainer">
                    <select name="data[PromotionApplyPackage][sex]" id="PromotionApplyPackageSex" style="width: 180px;" class="validate[required]">
                        <option value=""><?php echo INPUT_SELECT; ?></option>
                        <option value="1" <?php if($this->data['TravelPackageOrder']['sex'] == 1){ ?>selected=""<?php } ?>><?php echo "Male"; ?></option>
                        <option value="2" <?php if($this->data['TravelPackageOrder']['sex'] == 2){ ?>selected=""<?php } ?>><?php echo "Female"; ?></option>
                    </select>
                </div>
            </td>
        </tr>
            ...
            <td>
                <div class="inputContainer">
                    <select name="data[PromotionApplyPackage][travel_package_id]" id="PromotionApplyPackageSelected" style="width: 180px;" class="validate[required]">
                        ...
                        ?>
                        <option value="<?php echo $rowPackage['id']; ?>" <?php if($this->data['TravelPackageOrder']['travel_package_id'] == $rowPackage['id']){ ?>selected=""<?php } ?>><?php echo $rowPackage['name']; ?></option>
                        <?php
                        }
                        ?>
                    </select>
