...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#TCommisionEditForm").validationEngine('attach', {
            isOverflown: true,
            overflownDIV: ".ui-tabs-panel"
        });
        $("#TCommisionEditForm").ajaxForm({
...
<br />
<?php 
echo $this->Form->create('TCommision'); 
...
<fieldset>
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <div class="inputContainer">
                    <?php echo $this->Form->text('amount', array('class'=>'validate[funcCall[validate2fieldsTCommision]] float', 'value' => number_format($this->data['TCommision']['amount'], 2))); ?> ($)
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <div class="inputContainer">
                    <?php echo $this->Form->text('percentage', array('class'=>'validate[funcCall[validate2fieldsTCommision]] percent', 'value' => number_format($this->data['TCommision']['percentage'], 2))); ?> (%)
                </div>
            </td>
        </tr>
    </table>
