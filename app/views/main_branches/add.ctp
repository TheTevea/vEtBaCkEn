...
<script type="text/javascript">
    $(document).ready(function(){
        // Prevent Key Enter
        preventKeyEnter();
        $("#MainBranchAddForm").validationEngine('attach', {
            isOverflown: true,
            overflownDIV: ".ui-tabs-panel"
        });
        $("#MainBranchAddForm").ajaxForm({
            ...
            <fieldset style="height: 415px;">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td style="vertical-align: top;">
                            <select id="userMainBranchSelected" name="data[MainBranch][user_id][]" multiple="multiple" style="width: 300px; height: 200px;"></select>
                        </td>
                    </tr>
                </table>
            </fieldset>
