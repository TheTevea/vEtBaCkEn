...
<fieldset>
    ...
    <table>
        ...
        <tr>
            <td><label for="UserPassword"><?php echo USER_NEW_PASSWORD; ?> :</label></td>
            <td>
                <div class="inputContainer">
        ...
        <tr>
            ...
            <td>
                <div class="inputContainer">
                    <?php echo $this->Form->password('confirm_password', array('class'=>'validate[equals[UserPassword]]', 'name' => 'data[confirm_password]')); ?>
                </div>
            </td>
        </tr>
        <?php
