...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        <?php echo $oTable; ?> = $("#<?php echo $tblName; ?>").dataTable({
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<?php echo $this->base.'/'.$this->params['controller']; ?>/ajaxByGroupDateRange/<?php echo $chart_account_group_id; ?>/<?php echo $dateFrom; ?>/<?php echo $dateTo; ?>/<?php echo $companyId; ?>/<?php echo $customerId; ?>/<?php echo $vendorId; ?>/<?php echo $otherId; ?>/<?php echo $classId; ?>",
