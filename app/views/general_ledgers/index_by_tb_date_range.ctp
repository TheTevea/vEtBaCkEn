    ...
    $(document).ready(function(){
        ...
        $("#<?php echo $btnGo; ?>").click(function(event){
            if($("#<?php echo $filterDateFrom; ?>").val()=="" || $("#<?php echo $filterDateTo; ?>").val()==""){
                ...
                Tablesetting.sAjaxSource = "<?php echo $this->base . '/' . $this->params['controller']; ?>/ajaxByTbDateRange/<?php echo $chart_account_id; ?>/<?php echo $dateFrom; ?>/<?php echo $dateTo; ?>/<?php echo $companyId; ?>/<?php echo $customerId; ?>/<?php echo $vendorId; ?>/<?php echo $otherId; ?>/<?php echo $classId; ?>" + "/" + $("#<?php echo $filterDateFrom; ?>").val() + "/" + $("#<?php echo $filterDateTo; ?>").val() + "/" + $("#<?php echo $status; ?>").val() + "/" + $("#<?php echo $createdBy; ?>").val();
