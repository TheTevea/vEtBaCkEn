...
<script type="text/javascript">
    ...
    function eventKeyMakeDeposits(){
        ...
        $(".chart_account_id").change(function(){
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo $this->base . '/' . $this->params['controller']; ?>/checkCompany/" + chartAccountId + "/" + companyMankeDepositId,
                data: "",
                beforeSend: function(){
            ...
            <tr>
                ...
                <td style="text-align: left;">
                    <div class="inputContainer" style="width: 100%;">
                        <?php echo $this->Form->input('company_id', array('empty' => INPUT_SELECT, 'id' => 'GeneralLedgerMakeDepositsFormCompanyId', 'class' => 'validate[required]', 'label' => false, 'style' => 'width: 80%;')); ?>
                    </div>
                </td>
            </tr>
            <tr>
