...
<script type="text/javascript">
    ...
    function eventKeyMakeDeposits(){
        ...
        $('.chart_account_id').keyup(function(e){
            ...
            if(strSearchCombo!=''){
                ...
                if($(this).find("option:selected").attr("chart_account_type_name")=="Accounts Receivable"){
                    ...
                    $(this).closest("tr").find("td .choice").attr("class","choice validate[required,funcCall[checkVendor]] inputList");
        ...
        $(".chart_account_id").change(function(){
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo $this->base . '/' . $this->params['controller']; ?>/checkCompany/" + chartAccountId + "/" + companyMakeDepositId,
                data: "",
                beforeSend: function(){
