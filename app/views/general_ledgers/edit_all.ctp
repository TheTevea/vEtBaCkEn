...
<table id="tblGL" class="table" cellspacing="0">
    ...
    <tr class="tblJournalSuperRow">
        <td class="first" style="width: 15%;">
            <div class="inputContainer" style="width: 100%;">
                <?php echo $this->Form->input('company_id', array('empty' => INPUT_SELECT, 'id' => 'company_id'.$index, 'name' => 'company_id[]', 'value' => $dataGeneralLedgerDetail['company_id'],  'class' => 'company_id validate[required]', 'style' => 'width: 95%;', 'label' => false)); ?>
            </div>
        </td>
        <td>
