            ...
            <tr>
                ...
                <td>
                    <div class="inputContainer">
                        <?php echo $this->Form->input('company_id', array('empty' => INPUT_SELECT, 'label' => false, 'id' => 'GeneralLedgerAddFormCompanyId', 'class' => 'validate[required]')); ?>
                    </div>
                </td>
            </tr>
        </table>
    ...
    <tr id="tblJournalRow" class="tblJournalRow" style="visibility: hidden;">
        <td class="first" style="width: 20%;">
            <div class="inputContainer" style="width: 100%;">
                <select id="chart_account_id" name="chart_account_id[]" class="chart_account_id validate[required]" style="width: 95%;">
                    <option value=""></option>
                    <?php
