...
$statusAll   = "statusAll" . $rnd;
$statusClose = "statusClose" . $rnd;
$statusOpen  = "statusOpen" . $rnd;
$statusVoid  = "statusVoid" . $rnd;
$journey     = "journey" . $rnd;
    ...
    $(document).ready(function(){
        ...
        $("#<?php echo $btnSearch; ?>").click(function(){
            ...
            if(isFormValidated){
                ...
                var link = 'salesTicketBySeatResult';
...
<div class="legend">
    <div class="legend_title">
        <?php echo REPORT_SALES_TICKET_INFORMATION; ?> <span class="btnShowHide" id="<?php echo $btnShowHide; ?>">[<?php echo TABLE_HIDE; ?>]</span>
