...
/* DB table to use */
$sTable = "t_tickets INNER JOIN main_branches ON main_branches.id = t_tickets.main_branch_id INNER JOIN currency_centers ON currency_centers.id = t_tickets.currency_center_id LEFT JOIN payment_methods ON payment_methods.id = t_tickets.payment_method_id";
