...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#<?php echo $btnSearch; ?>").click(function(){
            ...
            var link = 'salesTicketFreeResult';
            if(isFormValidated){
...
<div class="legend">
    <div class="legend_title">
        <?php echo MENU_REPORT_SALES_TICKET_FREE; ?>
            ...
            <tr>
                ...
                <td style="width: 20%;">
                    <div class="inputContainer">
                        ...
                        echo $this->Form->select($company, $companies, null, array('escape' => false, 'name' => "", 'data-placeholder' => TABLE_ALL, 'multiple' => true, 'div' => false)); 
                        ?>
                    </div>
                </td>
