...
<script type="text/javascript">
    $(document).ready(function(){
        $("#<?php echo $agency; ?>").chosen({width: 220});
        ...
        $("#<?php echo $btnSearch; ?>").click(function(){
            ...
            if(isFormValidated){
                var link = 'agencyBalanceOfflineResult';
                if(viewBy == 2) {
                    link = 'agencyBalanceOfflineSummary';
                }
                $.ajax({
                    type: "POST",
...
<div class="legend">
    <div class="legend_title">
        <?php echo REPORT_AGENCY_BALANCE; ?> <!--<span class="btnShowHide" id="<?php echo $btnShowHide; ?>">[<?php echo TABLE_HIDE; ?>]</span>-->
    ...
    <div class="legend_content <?php echo $formFilter; ?>">
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 12%;"><?php echo $this->Form->select($dueDate, $dateRange, null, array('escape' => false, 'empty' => INPUT_SELECT, 'name' => false)); ?></td>
                ...
                <td style="width: 15%;" class="collectByUserView">
                    <div class="inputContainer">
