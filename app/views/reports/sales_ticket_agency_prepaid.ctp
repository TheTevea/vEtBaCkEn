...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#<?php echo $agency; ?>, #<?php echo $destinationFrom; ?>, #<?php echo $destinationTo; ?>, #<?php echo $mainBranch; ?>").chosen({width: 220});
        ...
        $("#<?php echo $btnSearch; ?>").click(function(){
            ...
            if(isFormValidated){
                ...
                if((issueDateFrom != "" && issueDateTo != "") || (travelDateFrom != "" && travelDateTo != "")){
                    var link = 'salesTicketAgencyPrepaidResult';
                    var viewBy = $("#<?php echo $viewBy; ?>").val();
                    if(viewBy == 2){
                        link = 'salesTicketAgencyPrepaidSummary';
                    }
                    $("input[name='status']").val($(".StatusBy:checked").val());
                    $(".StatusBy").removeAttr("name");
                    $("#reportAgencyPrepaidCompany").val($("#<?php echo $company; ?>").val());
                    $.ajax({
                        type: "POST",
...
<div class="legend">
    <div class="legend_title">
        <?php echo REPORT_SALES_TICKET_AGENCY_ONLINE; ?> (Prepaid)
    ...
    <div class="legend_content <?php echo $formFilter; ?>">
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 15%;">
                    <div class="inputContainer">
                        <input type="hidden" name="company" id="reportAgencyPrepaidCompany" />
                        <?php 
                        $comEmpty = false;
