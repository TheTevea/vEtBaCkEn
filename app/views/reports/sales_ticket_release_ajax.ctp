...
/* Customize condition */
$condition = 't_tickets.status > 0 AND t_ticket_details.is_active = 1 AND t_ticket_details.release_date IS NOT NULL AND t_ticket_details.release_date != "0000-00-00 00:00:00" AND t_tickets.offline_project_id = 1';
