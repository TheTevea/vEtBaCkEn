...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        <?php echo $oTable; ?> = $("#<?php echo $tblName; ?>").dataTable({
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<?php echo $this->base.'/'.$this->params['controller']; ?>/salesTicketShiftAjax/<?php echo str_replace("/", "|||", implode('-', $_POST)); ?>",
...
<div id="<?php echo $printArea; ?>">
    <?php
    $msg = '<b style="font-size: 18px;">' . REPORT_SALES_TICKET_CHANGE_SHIFT . '</b><br /><br />';
    if($_POST['date_from']!='') {
        ...
        <table id="<?php echo $tblName; ?>" class="table" style="width: 100%;">
            <thead>
                <tr>
                    ...
                    <th style="width: 130px !important; font-size: 11px;"><?php echo "Code Changed"; ?></th>
                    ...
                    <th style="width: 130px !important;  font-size: 11px;"><?php echo "Changed Date"; ?></th>
                    <th style="width: 160px !important; font-size: 11px;"><?php echo "Changed By"; ?></th>
                </tr>
            </thead>
            <tbody>
                <tr>
