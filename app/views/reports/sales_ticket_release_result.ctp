...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        <?php echo $oTable; ?> = $("#<?php echo $tblName; ?>").dataTable({
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<?php echo $this->base.'/'.$this->params['controller']; ?>/salesTicketReleaseAjax/<?php echo str_replace("/", "|||", implode('-', $_POST)); ?>",
...
<div id="<?php echo $printArea; ?>">
    <?php
    $msg = '<b style="font-size: 18px;">' . REPORT_SALES_TICKET_RELEASE . '</b><br /><br />';
        ...
        <table id="<?php echo $tblName; ?>" class="table_print" style="width: 1600px;">
            <thead>
                <tr>
                    ...
                    <th style="width: 110px !important; font-size: 11px;"><?php echo TABLE_CREATED; ?></th>
