...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#<?php echo $paymentMethod; ?>, #<?php echo $type; ?>").chosen({width: 350});
        ...
        $("#<?php echo $btnSearch; ?>").click(function(){
            ...
            if(isFormValidated){
                ...
                if((issueDateFrom != "" && issueDateTo != "") || (travelDateFrom != "" && travelDateTo != "")){
                    var link = 'salesTicketWebsiteResult';
                    $("input[name='status']").val($(".StatusBy:checked").val());
                    $(".StatusBy").removeAttr("name");
                    $("#reportSalesTicketWebsiteType").val($("#<?php echo $type; ?>").val());
                    $("#salesTicketWebAppPaymentType").val($("#<?php echo $paymentMethod; ?>").val());
                    $("#reportSalesTicketWebsiteCompany").val($("#<?php echo $company; ?>").val());
                    $.ajax({
                        type: "POST",
...
<div class="legend">
    <div class="legend_title">
        <?php echo MENU_REPORT_SALES_TICKET_WEBSITE; ?> <!--<span class="btnShowHide" id="<?php echo $btnShowHide; ?>">[<?php echo TABLE_SHOW; ?>]</span>-->
    ...
    <div class="legend_content <?php echo $formFilter; ?>">
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 15%;">
                    <div class="inputContainer">
                        <input type="hidden" name="type" id="reportSalesTicketWebsiteType" />
    ...
    <div class="legend_content <?php echo $formFilter; ?>">
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 25%;">
                    <div class="inputContainer">
                        <input type="hidden" name="payment_method" id="salesTicketWebAppPaymentType" />
                        <select id="<?php echo $paymentMethod; ?>" multiple="" data-placeholder="<?php echo TABLE_ALL; ?>">
                            <?php
                            $sqlPayMethod = mysql_query("SELECT * FROM payment_methods WHERE is_active = 1");
                ...
                <td style="width: 15%;">
                    <div class="inputContainer">
                        <input type="hidden" name="company" id="reportSalesTicketWebsiteCompany" />
                        <?php 
                        $comEmpty = false;
