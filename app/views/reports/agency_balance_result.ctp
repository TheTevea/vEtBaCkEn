...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        <?php echo $oTable; ?> = $("#<?php echo $tblName; ?>").dataTable({
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<?php echo $this->base.'/'.$this->params['controller']; ?>/agencyBalanceAjax/<?php echo str_replace("/", "|||", implode(',', $_POST)); ?>",
        ...
        $("#<?php echo $btnExport; ?>").click(function(){
            window.open("<?php echo $this->webroot; ?>public/report/ticket_agency_balance<?php echo $user['User']['id']; ?>.csv", "_blank");
        });
    });
</script>
<div id="<?php echo $printArea; ?>">
    <?php
    $msg = '<b style="font-size: 18px;">' . REPORT_AGENCY_BALANCE . '</b><br /><br />';
    if($_POST['date_from']!='') {
        ...
        <table id="<?php echo $tblName; ?>" class="table_report">
            <thead>
                <tr>
                    ...
                    <th style="width: 80px !important; text-align: right;"><?php echo "Selling Price"; ?></th>
                    <th style="width: 80px !important; text-align: right;"><?php echo "Net Price"; ?></th>
                    <th style="width: 80px !important; text-align: right;"><?php echo "Bonus"; ?></th>
