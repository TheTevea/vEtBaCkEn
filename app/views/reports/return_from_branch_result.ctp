...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        <?php echo $oTable; ?> = $("#<?php echo $tblName; ?>").dataTable({
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<?php echo $this->base.'/'.$this->params['controller']; ?>/returnFromBranchAjax/<?php echo str_replace("/", "|||", implode(',', $_POST)); ?>",
...
<div id="<?php echo $printArea; ?>">
    <?php
    $msg = '<b style="font-size: 18px;">' . MENU_REPORT_RETURN_FROM_BRANCH . '</b><br /><br />';
    if($_POST['date_from']!='') {
