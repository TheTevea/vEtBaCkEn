...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#<?php echo $branch; ?>, #<?php echo $mainBranch; ?>").chosen({width: 250});
        ...
        $("#<?php echo $btnSearch; ?>").click(function(){
            ...
            var link = 'cancelPhoneCallResult';
            if(isFormValidated){
                $("#reportCancelPhoneCallCompany").val($("#<?php echo $company; ?>").val());
                $.ajax({
                    type: "POST",
...
<div class="legend">
    <div class="legend_title">
        <?php echo MENU_REPORT_CANCEL_PHONE_CALL; ?> <span class="btnShowHide" id="<?php echo $btnShowHide; ?>">[<?php echo TABLE_HIDE; ?>]</span>
    ...
    <div class="legend_content <?php echo $formFilter; ?>">
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 15%;">
                    <div class="inputContainer">
                        <input type="hidden" name="company" id="reportCancelPhoneCallCompany" />
                        <?php 
                        $comEmpty = false;
                ...
                <td style="width: 8%;"><label for="<?php echo $telephone; ?>"><?php echo TABLE_TELEPHONE; ?>:</label></td>
                <td style="width: 15%;">
                    <div class="inputContainer">
                        <input type="text" id="<?php echo $telephone; ?>" name="telephone" />
                    </div>
                </td>
                <td></td>
            </tr>
