...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#<?php echo $btnSearch; ?>").click(function(){
            ...
            if(isFormValidated){
                var link = 'dailyRevenueSummaryResult';
                $.ajax({
                    type: "POST",
    ...
    <div class="legend_content <?php echo $formFilter; ?>">
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 10%;"><label for="<?php echo $dateFrom; ?>"><?php echo REPORT_FROM; ?>:</label></td>
                <td style="width: 15%;">
    ...
    <div class="legend_content <?php echo $formFilter; ?>">
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 10%;"><label for="<?php echo $journeyType; ?>"><?php echo MENU_JOURNEY_TYPE; ?>:</label></td>
                <td style="width: 15%;">
                    <div class="inputContainer">
                        <?php echo $this->Form->select($journeyType, $tJourneyTypes, null, array('escape' => false, 'name' => 'journey_type', 'multiple' => 'multiple', 'data-placeholder' => INPUT_SELECT, 'class'=>'chzn-select')); ?>
                    </div>
                </td>
                <td></td>
            </tr>
