...
<div class="legend">
    <div class="legend_title">
        <?php echo REPORT_SALES_TICKET_INFORMATION; ?> <!-- <span class="btnShowHide" id="<?php echo $btnShowHide; ?>">[<?php echo TABLE_SHOW; ?>]</span> -->
    ...
    <div class="legend_content <?php echo $formFilter; ?>">
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 7%;"><label for="<?php echo $paymentMethod; ?>"><?php echo TABLE_PAYMENT_METHOD; ?>:</label></td>
                <td style="width: 15%;">
                    <div class="inputContainer">
                        <?php
