...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        <?php echo $oTable; ?> = $("#<?php echo $tblName; ?>").dataTable({
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<?php echo $this->base.'/'.$this->params['controller']; ?>/salesTicketFreeAjax/<?php echo str_replace("/", "|||", implode(';', $_POST)); ?>",
...
<div id="<?php echo $printArea; ?>">
    <?php
    $msg = '<b style="font-size: 18px;">' . MENU_REPORT_SALES_TICKET_FREE . '</b><br /><br />';
    ...
    $sqlTicket = mysql_query("SELECT COUNT(t_ticket_details.id) AS total_booked, SUM(IFNULL(t_ticket_details.total_amount, 0) + IFNULL(t_ticket_details.vat_price, 0)) AS total_amount 
                              FROM 
                              t_ticket_details
