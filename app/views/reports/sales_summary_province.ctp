...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#<?php echo $mainBranch; ?>, #<?php echo $destinationFrom; ?>, #<?php echo $destinationTo; ?>, #<?php echo $province; ?>, #<?php echo $destGroup; ?>").chosen({width: 220});
        ...
        $("#<?php echo $btnSearch; ?>").click(function(){
            ...
            var link = 'salesSummaryProvinceResult';
            if(isFormValidated){
...
<div class="legend">
    <div class="legend_title">
        <?php echo REPORT_SALES_TICKET_BRANCH." Summary (City/Province)"; ?>
