        ...
        $("#<?php echo $btnSearch; ?>").click(function(){
            ...
            if(isFormValidated){
                ...
                if((issueDateFrom != "" && issueDateTo != "") || (travelDateFrom != "" && travelDateTo != "")){
                    var link   = 'agencyOnlinePostpaidResult';
                    var viewBy = $("#<?php echo $viewBy; ?>").val();
                    if(viewBy == 2){
                        link = 'agencyOnlinePostpaidSummary';
                    }
                    $("#reportAgencyPostpaidCompany").val($("#<?php echo $company; ?>").val());
                    $.ajax({
                        type: "POST",
...
<div class="legend">
    <div class="legend_title">
        <?php echo REPORT_SALES_TICKET_AGENCY_ONLINE_POSTPAID; ?>
    ...
    <div class="legend_content <?php echo $formFilter; ?>">
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 15%;">
                    <div class="inputContainer">
                        <input type="hidden" name="company" id="reportAgencyPostpaidCompany" />
                        <?php 
                        $comEmpty = false;
