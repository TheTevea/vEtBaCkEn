...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#<?php echo $btnSearch; ?>").click(function(){
            ...
            var link = 'phoneCallResult';
            if(isFormValidated){
                $("#reportPhoneCallCompany").val($("#<?php echo $company; ?>").val());
                $.ajax({
                    type: "POST",
...
<div class="legend">
    <div class="legend_title">
        <?php echo MENU_REPORT_PHONE_CALL; ?> <span class="btnShowHide" id="<?php echo $btnShowHide; ?>">[<?php echo TABLE_HIDE; ?>]</span>
    ...
    <div class="legend_content <?php echo $formFilter; ?>">
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 15%;">
                    <div class="inputContainer">
                        <input type="hidden" name="company" id="reportPhoneCallCompany" />
                        <?php 
                        $comEmpty = false;
                ...
                <td style="width: 15%;">
                    <div class="inputContainer">
                        <?php
                        echo $this->Form->select($mainBranch, $mainBranches, null, array('escape' => false, 'name' => 'main_branch', 'empty' => false)); 
                        ?>
                    </div>
                </td>
                <td></td>
