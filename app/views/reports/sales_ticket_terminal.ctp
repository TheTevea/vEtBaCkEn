...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#<?php echo $terminal; ?>, #<?php echo $destinationFrom; ?>, #<?php echo $destinationTo; ?>").chosen({width: 220});
        ...
        $("#<?php echo $btnSearch; ?>").click(function(){
            ...
            if(isFormValidated){
                ...
                if((issueDateFrom != "" && issueDateTo != "") || (travelDateFrom != "" && travelDateTo != "")){
                    var link = 'salesTicketTerminalResult';
                    $("input[name='status']").val($(".StatusBy:checked").val());
                    $(".StatusBy").removeAttr("name");
                    $("#reportTerminalCompany").val($("#<?php echo $company; ?>").val());
                    $.ajax({
                        type: "POST",
...
<div class="legend">
    <div class="legend_title">
        <?php echo MENU_REPORT_TERMINAL; ?> <!--<span class="btnShowHide" id="<?php echo $btnShowHide; ?>">[<?php echo TABLE_SHOW; ?>]</span>-->
    ...
    <div class="legend_content <?php echo $formFilter; ?>">
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 7%;"><label for="<?php echo $terminal; ?>"><?php echo MENU_TERMINAL; ?>:</label></td>
                <td style="width: 15%;">
                    <div class="inputContainer">
                        <?php
                        echo $this->Form->select($terminal, $terminals, null, array('escape' => false, 'name' => 'terminal', 'empty' => TABLE_ALL)); 
                        ?>
                    </div>
                </td>
                ...
                <td style="width: 15%;">
                    <div class="inputContainer">
                        <input type="hidden" name="company" id="reportTerminalCompany" />
                        <?php 
                        $comEmpty = false;
