        ...
        $("#<?php echo $btnSearch; ?>").click(function(){
            ...
            if(isFormValidated){
                ...
                if((issueDateFrom != "" && issueDateTo != "") || (travelDateFrom != "" && travelDateTo != "")){
                    var link = 'salesTicketAgencyVetDigitalResult';
                    $("input[name='status']").val($(".StatusBy:checked").val());
                    $(".StatusBy").removeAttr("name");
                    $("#reportVETDigitalCompany").val($("#<?php echo $company; ?>").val());
                    $.ajax({
                        type: "POST",
...
<div class="legend">
    <div class="legend_title">
        <?php echo REPORT_SALES_TICKET_AGENCY_ONLINE; ?> (VET Digital)
    ...
    <div class="legend_content <?php echo $formFilter; ?>">
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 8%;"><label for="<?php echo $bookingType; ?>"><?php echo TABLE_TYPE; ?>:</label></td>
                <td style="width: 15%;">
                    <div class="inputContainer">
                        <select id="<?php echo $bookingType; ?>" name="book_type">
                            <option value=""><?php echo TABLE_ALL; ?></option>
                            <option value="1">VET Digital (API)</option>
                            <option value="2">VET App (API)</option>
                            <option value="3">VET Digital (Manual)</option>
                            <option value="4">VET APP (Manual)</option>
                        </select>
                    </div>
                </td>
                <td></td>
    ...
    <div class="legend_content <?php echo $formFilter; ?>">
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 15%;">
                    <div class="inputContainer">
                        <input type="hidden" name="company" id="reportVETDigitalCompany" />
                        <?php 
                        $comEmpty = false;
