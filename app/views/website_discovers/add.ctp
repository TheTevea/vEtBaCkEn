...
<script type="text/javascript">
    $(document).ready(function(){
        // Prevent Key Enter
        preventKeyEnter();
        $("#WebsiteDiscoverAddForm").validationEngine('attach', {
            isOverflown: true,
            overflownDIV: ".ui-tabs-panel"
        });
        $("#WebsiteDiscoverAddForm").ajaxForm({
            ...
            success: function(result) {
                ...
                if(result != '<?php echo MESSAGE_DATA_HAS_BEEN_SAVED; ?>' && result != '<?php echo MESSAGE_DATA_COULD_NOT_BE_SAVED; ?>'){
                    createSysAct('WebsiteDiscover', 'Add', 2, result);
                    $("#dialog").html('<p><span class="ui-icon ui-icon-info" style="float:left; margin:0 7px 20px 0;"></span><?php echo MESSAGE_PROBLEM; ?></p>');
                }else {
                    createSysAct('WebsiteDiscover', 'Add', 1, '');
                    // alert message
    ...
    <table style="width: 100%">
        <tr>
            ...
            <td valign="top">
                ...
                <input type="file" id="WebsiteDiscoverPhoto" name="photo" disabled="" />
            </td>
        </tr>
        <tr>
            <td colspan="2" style="text-align: left;">
                <img id="WebsiteDiscoverPhotoDisplay" src="" style=" max-width: 140px; max-height: 140px;" />
            </td>
        </tr>
    </table>
</form>
...
<input type="hidden" id="<?php echo $photoNameHidden; ?>" name="data[WebsiteDiscover][photo]" />
<fieldset>
    <legend><?php __(MENU_WEBSITE_DISCOVER_ADD); ?></legend>
    <table cellpadding="5">
        <tr>
