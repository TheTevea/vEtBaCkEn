...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $("#PromotionPackageAddForm").validationEngine('attach', {
            isOverflown: true,
            overflownDIV: ".ui-tabs-panel"
        });
        $("#PromotionPackageAddForm").ajaxForm({
    ...
    function eventKeyPromotionPackageDestination(){
        $(".PromotionPackageDestination, .btnAddRowPromotionPackageDestination, .btnRemoveRowPromotionPackageDestination").unbind('click').unbind('change');
        $(".PromotionPackageDestination").chosen({width: 280});
            ...
            <td>
                <div class="inputContainer">
                    <select name="data[PromotionPackage][destination_apply]" id="PromotionPackageApplyDestination" style="width: 180px;">
                        ...
                        <option value="2"><?php echo "Customize"; ?></option>
                    </select>
                </div>
            </td>
        </tr>
