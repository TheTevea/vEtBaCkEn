...
<script type="text/javascript">
    $(document).ready(function(){
        // Prevent Key Enter
        preventKeyEnter();
        $("#TBoatAddForm").validationEngine('attach', {
            isOverflown: true,
            overflownDIV: ".ui-tabs-panel"
        });
        $("#TBoatAddForm").ajaxForm({
...
<br />
<?php echo $this->Form->create('TBoat'); ?>
<fieldset>
            ...
            <td>
                <div class="inputContainer">
                    <select id="TBoatTTransportationTypeId" name="data[TBoat][t_transportation_type_id]" class="validate[required]">
                        ...
                        ?>
                        <option value="<?php echo $dataType['id']; ?>"><?php echo $dataType['name']; ?></option>
                        <?php                                        
                            }
                        ?> 
                    </select>
