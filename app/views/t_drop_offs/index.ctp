...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        oTableTDropOff = $("#<?php echo $tblName; ?>").dataTable({
            "bProcessing": true,
            "bServerSide": true,
            ...
            "fnInfoCallback": function( oSettings, iStart, iEnd, iMax, iTotal, sPre ) {
                ...
                $(".btnViewTDropOff").click(function(event){
                ...
                $(".btnEditTDropOff").click(function(event){
                    event.preventDefault();
                    var id = $(this).attr('rel');
                    var leftPanel=$(this).parent().parent().parent().parent().parent().parent().parent();
                    var rightPanel=leftPanel.parent().find(".rightPanel");
                ...
                $(".btnDeleteTDropOff").click(function(event){
                    event.preventDefault();
                    var id = $(this).attr('rel');
                                ...
                                $.ajax({
                                    ...
                                    success: function(result){
                                        ...
                                        if(result != '<?php echo MESSAGE_DATA_HAS_BEEN_DELETED; ?>'){
                                            createSysAct('TDropOff', 'Delete', 2, result);
                                            $("#dialog").html('<p><span class="ui-icon ui-icon-info" style="float:left; margin:0 7px 20px 0;"></span><?php echo MESSAGE_PROBLEM; ?></p>');
                                        }else {
                                            createSysAct('TDropOff', 'Delete', 1, '');
                                            // alert message
        ...
        $(".btnAddTDropOff").click(function(event){
            event.preventDefault();
        ...
        $("#<?php echo $btnExport; ?>").click(function(event){
            ...
            $.ajax({
                ...
                success: function(){
                    ...
                    window.open("<?php echo $this->webroot; ?>public/report/dropoff_point.csv", "_blank");
                }
            });
        });
    });
...
<div class="leftPanel">
    <div style="padding: 5px;border: 1px dashed #bbbbbb;">
        ...
        <div class="buttons">
            <a href="" class="positive btnAddTDropOff">
                <img src="<?php echo $this->webroot; ?>img/button/plus.png" alt=""/>
                <?php echo MENU_ADD_NEW_DROP_OFF; ?>
            </a>
        </div>
        <?php } ?>
        <div class="buttons">
