...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        // Hide Branch
        <?php
        if(!empty($this->data['TJourney']['company_id'])){
        ?>
        ...
        ?>
        $("#TJourneyBranchId").filterOptions('com', '0', '');
        <?php
        }
        ?>
        $("#TJourneyAddForm").validationEngine('attach', {
            isOverflown: true,
            overflownDIV: ".ui-tabs-panel"
        });
        $("#TJourneyAddForm").ajaxForm({
        ...
        $("#TJourneyCompanyId").unbind('change').change(function(){
            var obj = $(this);
            $("#TJourneyBranchId").filterOptions('com', obj.val(), '');
            $("#TJourneyBranchId").trigger("chosen:updated");
        });
        
        $("#TJourneyBranchId").unbind('change').change(function(){
            var symbol = $(this).find("option:selected").attr("symbol");
            $(".TJourneySymbolCurrency").html(symbol);
            // Reset Journey Transit By Branch
            $(".JourneyRouteMulti").filterOptions('branch', $(this).val(), '');
        });
        
        $("#TJourneyAgentPriceAmount, #TJourneyAgentRoundPrice, #TJourneyUnitPrice, #TJourneyMembership, #TJourneyRoundPrice, #TJourneyRoundPriceVip").unbind('focus').focus(function(){
            if(replaceNum($(this).val()) == 0){
                $(this).val('');
            }
        });
        
        $("#TJourneyAgentPriceAmount, #TJourneyAgentRoundPrice, #TJourneyUnitPrice, #TJourneyMembership, #TJourneyRoundPrice, #TJourneyRoundPriceVip").unbind('blur').blur(function(){
            if($(this).val() == ''){
                $(this).val('0');
            }
        });
        ...
        $("#JourneyDirection").unbind('click').click(function(){
            ...
            $("#TJourneyTransportRouteDisplay").val("Direct");
        });
        ...
        $("#JourneyTransit").unbind('click').click(function(){
            ...
            // Transport Route Display
            $("#TJourneyTransportRouteDisplay").val("Transit");
        });
        ...
        $("#tJourneyClearPromotion").unbind("click").click(function(){
            ...
            $("#TJourneyDiscount, #TJourneyDiscountAmt").val(0);
            $("#TJourneyDiscountFrom, #TJourneyDiscountTo, #TJourneyDiscount").removeClass("validate[required]");
        });

        $("#TJourneyDiscount, #TJourneyDiscountAmt").unbind("focus").focus(function(){
            if(replaceNum($(this).val()) == 0){
                $(this).val("");
            }
        });
        ...
        $("#TJourneyDiscountAmt").unbind("blur").blur(function(){
            if(replaceNum($(this).val()) > 100){
                $(this).val(100);
            } else if($(this).val() == ""){
                $(this).val(0);
        ...
        <?php
        if(!empty($this->data['TJourney']['id'])){
            $sqlDropOff = mysql_query("SELECT * FROM t_journey_drop_offs WHERE t_journey_id = ".$this->data['TJourney']['id']);
        ...
        <?php    
            ...
            $sqlBoardingPoint = mysql_query("SELECT * FROM t_journey_boarding_points WHERE t_journey_id = ".$this->data['TJourney']['id']);
    ...
    function cloneBoardingPoint(required){
        rowIndexJourney = Math.floor((Math.random() * 100000) + 1);
        ...
        if(required != ''){
            tr.find(".JourneyBoardingPoint, .JourneyBoardingPointHour, .JourneyBoardingPointMinute").addClass('validate[required]');
        }
    ...
    function cloneDropOff(required){
        rowIndexJourney = Math.floor((Math.random() * 100000) + 1);
        ...
        if(required != ''){
            tr.find(".JourneyDropOff, .JourneyDropOffHour, .JourneyDropOffMinute").addClass('validate[required]');
        }
...
<br />
<?php echo $this->Form->create('TJourney'); ?>
<fieldset style="width: 48%; float: left; min-height: 900px;">
...
<!--        <tr>
            ...
            <td>
                <div class="inputContainer">
                    <select name="data[TJourney][t_route_id]" id="TJourneyTRouteId" style="width: 260px;" class="journeySelectChz">
                        ...
                        <option value="<?php echo $tRoute['TRoute']['id']; ?>"><?php echo $tRoute['TRoute']['name']; ?></option>
                        <?php } ?>
                    </select>
                </div>
            </td>
        ...
        <tr>
            ...
            <td>
                <div class="inputContainer">
                    <?php 
                        if(empty($this->data['TJourney']['vehicle_type'])) {
                            $this->data['TJourney']['vehicle_type'] = "";
                        }
                    ?>
        ...
        <tr>
            ...
            <td>
                <div class="inputContainer">
                    <?php 
                        if(empty($this->data['TJourney']['gender_require'])) {
                            $this->data['TJourney']['gender_require'] = "";
                        }
                    ?>
        ...
        <tr>
            ...
            <td>
                <div class="inputContainer">
                    <?php echo $this->Form->text('unit_price', array('class'=>'validate[required] float', 'style' => 'width: 240px')); ?> <span class="TJourneySymbolCurrency"></span>
                    <?php echo $this->Form->hidden('foreigner_price', array('class'=>'float', 'value' => '0')); ?>
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <div class="inputContainer">
                    <?php echo $this->Form->text('membership', array('class'=>'validate[required] float', 'style' => 'width: 240px')); ?> <span class="TJourneySymbolCurrency"></span>
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <div class="inputContainer">
                    <?php echo $this->Form->text('agent_price_amount', array('class'=>'validate[required] float', 'style' => 'width: 240px')); ?> <span class="TJourneySymbolCurrency"></span>
                    <?php echo $this->Form->hidden('agetn_price_percent', array('class'=>'float', 'value' => '0')); ?>
                </div>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <div class="inputContainer">
                    <?php echo $this->Form->text('round_price', array('class'=>'validate[required] float', 'style' => 'width: 240px')); ?> <span class="TJourneySymbolCurrency"></span>
                </div>
            </td>
        </tr>
        <tr>
            <td><label for="TJourneyRoundPrice"><?php echo "Round Trip Price VIP Card"; ?> <span class="red">*</span> :</label></td>
            <td>
                <div class="inputContainer">
                    <?php echo $this->Form->text('round_price_vip', array('class'=>'validate[required] float', 'style' => 'width: 240px')); ?> <span class="TJourneySymbolCurrency"></span>
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <div class="inputContainer">
                    <?php echo $this->Form->text('agent_round_price', array('class'=>'validate[required]float', 'style' => 'width: 240px')); ?> <span class="TJourneySymbolCurrency"></span>
                </div>
            </td>
        </tr>
        <tr>
...
<fieldset style="width: 48%; float: right; min-height: 900px;">
    ...
    <table cellpadding="3">
        <tr>
            ...
            <td>
                <?php  
                    if(!empty($this->data['TDepartureTime']['name'])){
        ...
        <tr>
            ...
            <td colspan="2">
                ...
                if(empty($this->data['TJourney']['reject_bf_dep_sch_walk_in'])) {
                    $this->data['TJourney']['reject_bf_dep_sch_walk_in'] = 0;
                }
                if(empty($this->data['TJourney']['reject_bf_dep_sch_online'])) {
                    $this->data['TJourney']['reject_bf_dep_sch_online'] = 0;
                }
                if(empty($this->data['TJourney']['reject_bf_dep_sch_api'])) {
                    $this->data['TJourney']['reject_bf_dep_sch_api'] = 0;
                }
                ?>
        ...
        <tr>
            ...
            <td>
                <div class="inputContainer">
                    <?php 
                        if(empty($this->data['TJourney']['delay_af_departure'])) {
                            $this->data['TJourney']['delay_af_departure'] = "";
                        }
                    ?>
            ...
            <td>
                <div class="inputContainer">
                    <?php
                        if(empty($this->data['TJourney']['id'])) {
                    ?>
                    <input type="checkbox" name="journey_schedule[]" class="validate[required, minCheckbox[1]]" value="7" id="TJourneyScheduleSun" style="margin-bottom: 10px;" /> <label for="TJourneyScheduleSun"><?php echo TABLE_SUNDAY; ?></label><br/>
                    <input type="checkbox" name="journey_schedule[]" class="validate[required, minCheckbox[1]]" value="1" id="TJourneyScheduleMon" style="margin-bottom: 10px;" /> <label for="TJourneyScheduleMon"><?php echo TABLE_MONDAY; ?></label><br/>
                    <input type="checkbox" name="journey_schedule[]" class="validate[required, minCheckbox[1]]" value="2" id="TJourneyScheduleTue" style="margin-bottom: 10px;" /> <label for="TJourneyScheduleTue"><?php echo TABLE_TUESDAY; ?></label><br/>
                    <input type="checkbox" name="journey_schedule[]" class="validate[required, minCheckbox[1]]" value="3" id="TJourneyScheduleWed" style="margin-bottom: 10px;" /> <label for="TJourneyScheduleWed"><?php echo TABLE_WEDNESDAY; ?></label><br/>
                    <input type="checkbox" name="journey_schedule[]" class="validate[required, minCheckbox[1]]" value="4" id="TJourneyScheduleThu" style="margin-bottom: 10px;" /> <label for="TJourneyScheduleThu"><?php echo TABLE_THURSDAY; ?></label><br/>
                    <input type="checkbox" name="journey_schedule[]" class="validate[required, minCheckbox[1]]" value="5" id="TJourneyScheduleFri" style="margin-bottom: 10px;" /> <label for="TJourneyScheduleFri"><?php echo TABLE_FRIDAY; ?></label><br/>
                    <input type="checkbox" name="journey_schedule[]" class="validate[required, minCheckbox[1]]" value="6" id="TJourneyScheduleSat" /> <label for="TJourneyScheduleSat"><?php echo TABLE_SATURDAY; ?></label>
                    <?php
                    }else{
        ...
        <tr>
            ...
            <td style="vertical-align: top;">
                <div class="inputContainer" id="dvAllowAccessOutside">
                    <?php 
                        if(empty($this->data['TJourney']['allow_access'])) {
                            $this->data['TJourney']['allow_access'] = 0;
                        }
                    ?>
        ...
        <tr>
            ...
            <td style="vertical-align: top;">
                <div class="inputContainer">
                    <?php echo $this->Form->text('price_period_from', array('style' => 'width: 240px', 'readonly' => true, 'autocomplete' => false)); ?>
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td style="vertical-align: top;">
                <div class="inputContainer">
                    <?php echo $this->Form->text('price_period_to', array('style' => 'width: 240px', 'readonly' => true, 'autocomplete' => false)); ?>
                </div>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <div class="inputContainer">
                    <?php echo $this->Form->text('price_period_price', array('class'=>'float', 'style' => 'width: 200px; height: 20px;', 'autocomplete' => 'off')); ?> <span class="TJourneySymbolCurrency"></span>
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <div class="inputContainer">
                    <?php echo $this->Form->text('price_period_membership', array('class'=>'float', 'style' => 'width: 200px; height: 20px;', 'autocomplete' => 'off')); ?> <span class="TJourneySymbolCurrency"></span>
                </div>
            </td>
        </tr>
        <tr>
            <td><label for="TJourneyPricePeriodAgencyPrice"><?php echo "Agency Price"; ?> :</label></td>
            <td>
                <div class="inputContainer">
                    <?php echo $this->Form->text('price_period_agency_price', array('class'=>'float', 'style' => 'width: 200px; height: 20px;', 'autocomplete' => 'off')); ?> <span class="TJourneySymbolCurrency"></span>
                </div>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <div class="inputContainer">
                    <?php echo $this->Form->text('price_period_round_price', array('class'=>'float', 'style' => 'width: 200px; height: 20px;', 'autocomplete' => 'off')); ?> <span class="TJourneySymbolCurrency"></span>
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <div class="inputContainer">
                    <?php echo $this->Form->text('price_period_round_price_vip', array('class'=>'float', 'style' => 'width: 200px; height: 20px;', 'autocomplete' => 'off')); ?> <span class="TJourneySymbolCurrency"></span>
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <div class="inputContainer">
                    <?php echo $this->Form->text('price_period_agency_round_price', array('class'=>'float', 'style' => 'width: 200px; height: 20px;', 'autocomplete' => 'off')); ?> <span class="TJourneySymbolCurrency"></span>
                </div>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="vertical-align: top;">
                <div class="inputContainer">
                    <?php echo $this->Form->text('price_period_from_internal', array('style' => 'width: 240px', 'readonly' => true, 'autocomplete' => false)); ?>
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td style="vertical-align: top;">
                <div class="inputContainer">
                    <?php echo $this->Form->text('price_period_to_internal', array('style' => 'width: 240px', 'readonly' => true, 'autocomplete' => false)); ?>
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <div class="inputContainer">
                    <?php echo $this->Form->text('price_period_price_internal', array('class'=>'float', 'style' => 'width: 200px; height: 20px;', 'autocomplete' => 'off')); ?> <span class="TJourneySymbolCurrency"></span>
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <div class="inputContainer">
                    <?php echo $this->Form->text('price_period_round_price_internal', array('class'=>'float', 'style' => 'width: 200px; height: 20px;', 'autocomplete' => 'off')); ?> <span class="TJourneySymbolCurrency"></span>
                </div>
            </td>
        </tr>
    </table>
...
<fieldset style="width: 48%; float: left; height: 400px; overflow-x: hidden; overflow-y: scroll;">
    ...
    <table cellpadding="0" cellspacing="0" style="width: 90%;">
        <tr>
            ...
            <td>
                <?php echo $this->Form->text('transport_route_display', array('style' => 'width: 300px; height: 20px;', 'autocomplete' => 'off', 'value' => 'Direct')); ?>
            </td>
        </tr>
    </table>
    <br />
    <table cellpadding="0" cellspacing="0" style="width: 90%;">
        <tr>
            <td style="width: 20%;"><input type="radio" name="data[TJourney][type]" value="1" checked="" id="JourneyDirection" /> <label for="JourneyDirection">Direct</label></td>
            <td style="width: 20%;"><input type="radio" name="data[TJourney][type]" value="2" id="JourneyTransit" /> <label for="JourneyTransit">Transit</label></td>
            <td><input type="radio" name="data[TJourney][type]" value="3" id="JourneyDirectionMultiRoute" /> <label for="JourneyDirectionMultiRoute">Direct Multi Route</label></td>
        </tr>
    </table>
    <br/>
    <table class="table" cellpadding="0" cellspacing="0" style="width: 100%; display: none;" id="divRouteMultiJourney">
        <tr>
        ...
        <tbody id="rowRouteMultiList">
            <tr id="rowListRouteMulti" class="rowListRouteMulti">
                <td class="first">
                    <div class="inputContainer" style="width: 100%;">
                        <select name="data[journey_transit_id][]" class="JourneyRouteMulti" style="width: 95%; height: 25px;" class="validate[required]">
    ...
    <!-- Transit -->
    <table cellpadding="0" cellspacing="0" style="width: 100%; display: none;" id="divTransitJourney">
                                ...
                                <table class="table" cellpadding="0" cellspacing="0" style="width: 100%;">
                                    ...
                                    <tbody class="rowTransitListDetail">
                                        <tr id="rowListTransitDetail" class="rowListTransitDetail">
                                            <td class="first">
                                                <div class="inputContainer" style="width: 100%;">
                                                    <select name="data[journey_transit_id][]" class="JourneyTransit" style="width: 95%; height: 25px;" class="validate[required]"></select>
                                                </div>
                                            </td>
                                            <td>
...
<fieldset style="width: 48%; float: right; height: 400px; display: none;">
    <legend><?php __(MENU_AGENT); ?></legend>
    <table cellpadding="3" style="width: 90%;">
        <tr>
            <td><?php echo TABLE_APPLY_TO_ALL_AGENT; ?> <span class="red">*</span> :</td>
            <td>
                <div class="inputContainer">
                    (KH) <?php //echo $this->Form->text('agent_price_amount', array('class'=>'validate[required] float', 'style' => 'width: 120px')); ?> <span class="TJourneySymbolCurrency"></span>
                    (FG) <?php //echo $this->Form->text('agetn_price_percent', array('class'=>'validate[required] float', 'style' => 'width: 120px')); ?> <span class="TJourneySymbolCurrency"></span>
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="2">
                ...
                <table class="table" cellpadding="0" cellspacing="0" style="width: 100%;">
                    <tr>
                        ...
                        <th style="width: 22%;">(FG) <?php echo GENERAL_AMOUNT; ?> (<span class="TJourneySymbolCurrency"></span>)</th>
                        <th style="width: 6%;"></th>
                    </tr>
