...
<div class="print_doc" style="width: 300px;">
    ...
    if($this->data['TTicket']['is_open_date'] == 0){
        $number = 1;
        $sqlSeat = mysql_query("SELECT IFNULL(label_number, seat_number), unit_price, discount, total_amount FROM t_ticket_details WHERE t_ticket_details.t_ticket_id = ".$this->data['TTicket']['id']);
        while($rowSeat = mysql_fetch_array($sqlSeat)){
            ...
            if($this->data['TTicket']['price_type'] == 1){
                ...
                $customerType = $this->data['TAgent']['name'];
    ...
    <div style="width: 100%;" class="<?php echo $pageBreak; ?>">
        ...
        <table style="width: 100%;" cellpadding="0" cellspacing="3">
            <tr>
                ...
                <td style="font-size: 10px;"><?php echo number_format($rowSeat['total_amount'] - $rowSeat['discount'], 2)." ".$this->data['CurrencyCenter']['symbol']; ?></td>
            </tr>
            <tr>
                <td style="font-size: 10px;" colspan="2">Agency Ref :</td>
                <td style="font-size: 10px;" colspan="2"><?php echo $this->data['TTicket']['agt_refer_code']; ?></td>
    ...
    <table style="width: 100%;" class="<?php echo $ticketBreak; ?>">
        <tr>
                ...
                <table cellpadding="0" cellspacing="0" style="width: 100%;">
                    <tr>
                        <td style="vertical-align: top; text-align: center; width: 100px; font-size: 14px;">
                            ...
                            <div style="font-size: 10px;"><?php echo $this->data['Company']['website']; ?></div>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: center; font-size: 10px; font-weight: bold;">
                            <?php
                            if($this->data['Company']['type'] == 2){
                            ?>
                            SPEED FERRY TICKET
                            <?php
                            } else {
            ...
            <td style="width: 15%; font-size: 26px; font-weight: bold;">
                <?php
                if($this->data['TTicket']['t_agent_id'] == ""){
    ...
    <table style="width: 100%; margin-top: 5px;">
        ...
        <tr>
            <td style="font-size: 10px;">លេខយោង/Reference Code : 
                <?php 
                echo $this->data['TTicket']['agt_refer_code']; 
                ?>
            </td>
        </tr>
        <?php
    ...
    <table style="width: 100%; margin-top: 5px;" cellspacing="0">
        ...
        <tr>
            <td style="border-top: 1px solid #000; border-left: 1px solid #000; border-bottom: 1px solid #000; font-size: 10px;">តម្លៃ/Amount</td>
            <td style="border-top: 1px solid #000; border-left: 1px solid #000; border-right: 1px solid #000; border-bottom: 1px solid #000; padding-left: 5px; font-size: 10px;"><?php echo number_format($rowSeat['total_amount'] - $rowSeat['discount'], 2)." ".$this->data['CurrencyCenter']['symbol']; ?></td>
        </tr>
    </table>
    <table style="width: 100%; margin-top: 5px;" cellspacing="0">
        <tr>
    ...
    <?php
        ...
        for($number=1;$number<=$this->data['TTicket']['total_seat'];$number++){
            $seatNum = '';
            if($this->data['TTicket']['total_seat'] > 1){
                $seatNum = "-".$number;
            }
    ?>
    ...
    <table style="width: 100%; margin-top: 5px;">
        ...
        <tr>
            <td style="font-size: 10px;">
                លេខសំបុត្រ/Ticket No. : <b><?php echo $this->data['TTicket']['code'].$seatNum; ?></b>
            </td>
        </tr>
        <tr>
            <td style="font-size: 10px;">ប្រភេទអតិថិជន/Type Of Customer : 
    ...
    <table style="width: 100%; margin-top: 5px;" cellspacing="0">
        ...
        <tr>
            ...
            <td style="border-top: 1px solid #000; border-left: 1px solid #000; border-right: 1px solid #000; border-bottom: 1px solid #000; padding-left: 5px; font-size: 10px;"><?php echo number_format($this->data['TTicket']['price'], 2)." ".$this->data['CurrencyCenter']['symbol']; ?></td>
        </tr>
    </table>
    <table style="width: 100%; margin-top: 5px;" cellspacing="0">
        <tr>
        ...
        <tr>
            <td colspan="2" style="font-size: 8px;">
                ប្រសិនលោកអ្នកចង់ត្រលប់មកវិញ សូមមេត្តាផ្តល់ដំណឹងជូនយើងមួយថ្ងៃមុនពេលចេញដំណើរ។
            </td>
        </tr>
        <tr>
            <td colspan="2" style="font-size: 8px;">
                If you want to come back please confirm us one day before departure time.
            </td>
        </tr>
        <tr>
            <td style="font-size: 8px; padding-top: 5px;">
