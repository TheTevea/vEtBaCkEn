...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        ?>
        var tabWidth = $(".ui-layout-center").height() - 200;
        ...
        $("#ticketBookingDate").datepicker( "option", "minDate", 0 );
        // Search Schedule
                                        ...
                                        $.ajax({
                                            ...
                                            success: function(result){
                                                ...
                                                if(result.error == '0'){
                                                    ...
                                                    var boarding = $("#ticketBookingBoardingPoint").text();
                                                    var dropOff  = $("#ticketBookingDropOff").text();
...
<div class="leftPanel">
        ...
        <div style="width: 1024px; height: <?php echo $tableHeight; ?>px; padding: 5px; color: #fff; margin-top: 2px; margin: 0px auto;">
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td style="width: 165px;">
                        <!-- Date -->
                        <input type="text" id="ticketBookingDate" style="width: 150px; height: 25px; font-size: 14px;  border: none;" value="<?php echo date("d/m/Y"); ?>" />
                    </td>
    ...
    <div style="width: 100%; margin-top: 10px;">
        <div style="width: 1024px; margin: 0px auto; overflow: auto;" id="journeyScheduleList"></div>
    </div>
</div>