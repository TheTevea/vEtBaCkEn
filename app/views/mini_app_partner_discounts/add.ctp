...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#MiniAppPartnerDiscountAddForm").validationEngine('attach', {
            isOverflown: true,
            overflownDIV: ".ui-tabs-panel"
        });
        $("#MiniAppPartnerDiscountAddForm").ajaxForm({
            ...
            success: function(result) {
                ...
                if(result != '<?php echo MESSAGE_DATA_HAS_BEEN_SAVED; ?>' && result != '<?php echo MESSAGE_DATA_COULD_NOT_BE_SAVED; ?>'){
                    createSysAct('MiniAppPartnerDiscount', 'Add', 2, result);
                    $("#dialog").html('<p><span class="ui-icon ui-icon-info" style="float:left; margin:0 7px 20px 0;"></span><?php echo MESSAGE_PROBLEM; ?></p>');
                }else {
                    createSysAct('MiniAppPartnerDiscount', 'Add', 1, '');
...
<fieldset>
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <div class="inputContainer">
                    <?php echo $this->Form->text('fixed_discount', array('class'=>'validate[required] float', 'style' => 'width: 250px;', 'value' => '0')); ?>
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <div class="inputContainer">
                    <?php echo $this->Form->text('percent', array('class'=>'validate[required] float', 'style' => 'width: 250px;', 'value' => '0')); ?>
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <div class="inputContainer">
                    <input type="text" name="data[MiniAppPartnerDiscount][start_date]" id="MiniAppPartnerDiscountStartDate" class="validate[required]" style="width: 250px;" value="" readonly="readonly" />
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <div class="inputContainer">
                    <input type="text" name="data[MiniAppPartnerDiscount][end_date]" id="MiniAppPartnerDiscountEndDate" class="validate[required]" style="width: 250px;" value="" readonly="readonly" />
                </div>
            </td>
        </tr>
        <tr>
