...
<script type="text/javascript">
    var oTableTJourneyPriceDefault;
    $(document).ready(function(){
        // Prevent Key Enter
        preventKeyEnter();
        $("#<?php echo $tblName; ?> td:first-child").addClass('first');
        oTableTJourneyPriceDefault = $("#<?php echo $tblName; ?>").dataTable({
            "bProcessing": true,
            "bServerSide": true,
            ...
            "fnInfoCallback": function( oSettings, iStart, iEnd, iMax, iTotal, sPre ) {
                ...
                $(".btnViewTJourneyPriceDefault").click(function(event){
                ...
                $(".btnDeleteTJourneyPriceDefault").click(function(event){
                    event.preventDefault();
                    var id = $(this).attr('rel');
...
//                                            createSysAct('TJourneyPriceDefault', 'Delete', 2, result);
//                                            $("#dialog").html('<p><span class="ui-icon ui-icon-info" style="float:left; margin:0 7px 20px 0;"></span><?php echo MESSAGE_PROBLEM; ?></p>');
//                                        }else {
//                                            createSysAct('TJourneyPriceDefault', 'Delete', 1, '');
                                            // alert message
...
//                                        }
        ...
        $(".btnAddTJourneyPriceDefault").click(function(event){
            event.preventDefault();
...
<div class="leftPanel">
    ...
    <div style="padding: 5px;border: 1px dashed #bbbbbb;">
        <div class="buttons">
            <a href="" class="positive btnAddTJourneyPriceDefault">
                <img src="<?php echo $this->webroot; ?>img/button/plus.png" alt=""/>
                <?php echo MENU_SET_PRICE_DEFAULT_ADD; ?>
            </a>
        </div>
