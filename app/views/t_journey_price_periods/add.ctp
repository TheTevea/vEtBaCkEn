...
<fieldset>
    ...
    <table>
        <tr>
            ...
            <td>
                <div class="inputContainer">
                    <select name="data[TJourneyPricePeriod][apply_to]" id="TJourneyPricePeriodApplyTo" style="width: 210px; height: 35px;" class="validate[required]">
        ...
        <tr id="divTJourneyPricePeriodMainBranchId" style="display: none;">
        ...
        <tr>
            ...
            <td>
                <div class="inputContainer">
                    <?php echo $this->Form->input('t_transportation_type_id', array('class'=>'validate[required]', 'label' => false, 'multiple' => 'multiple', 'data-placeholder' => INPUT_SELECT, 'div' => false, 'style' => 'width: 400px; height: 35px;')); ?>
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <div class="inputContainer" style="width: 100%;">
                    <input type="text" name="data[TJourneyPricePeriod][start]" id="TJourneyPricePeriodStart" class="validate[required]" style="width: 200px; height: 20px;" />
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <div class="inputContainer" style="width: 100%;">
                    <input type="text" name="data[TJourneyPricePeriod][end]" id="TJourneyPricePeriodEnd" class="validate[required]" style="width: 200px; height: 20px;" />
                </div>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <div class="inputContainer">
                    <?php echo $this->Form->text('price', array('class'=>'validate[required] float', 'style' => 'width: 200px; height: 20px;', 'autocomplete' => 'off')); ?> <?php echo $symbol; ?>
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <div class="inputContainer">
                    <?php echo $this->Form->text('foreigner_price', array('class'=>'validate[required] float', 'style' => 'width: 200px; height: 20px;', 'autocomplete' => 'off')); ?> <?php echo $symbol; ?>
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <div class="inputContainer">
                    <?php echo $this->Form->text('membership', array('class'=>'validate[required] float', 'style' => 'width: 200px; height: 20px;', 'autocomplete' => 'off')); ?> <?php echo $symbol; ?>
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <div class="inputContainer">
                    <?php echo $this->Form->text('agency_price', array('class'=>'validate[required] float', 'style' => 'width: 200px; height: 20px;', 'autocomplete' => 'off')); ?> <?php echo $symbol; ?>
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <div class="inputContainer">
                    <?php echo $this->Form->text('agency_price_foreigner', array('class'=>'validate[required] float', 'style' => 'width: 200px; height: 20px;', 'autocomplete' => 'off')); ?> <?php echo $symbol; ?>
                </div>
            </td>
        </tr>
    </table>
