...
<script type="text/javascript">
    var oTableTJourneyPricePeriod;
    $(document).ready(function(){
        // Prevent Key Enter
        preventKeyEnter();
        $("#<?php echo $tblName; ?> td:first-child").addClass('first');
        oTableTJourneyPricePeriod = $("#<?php echo $tblName; ?>").dataTable({
            "bProcessing": true,
            "bServerSide": true,
            ...
            "fnInfoCallback": function( oSettings, iStart, iEnd, iMax, iTotal, sPre ) {
                ...
                $(".btnViewTJourneyPricePeriod").click(function(event){
                ...
                $(".btnEditTJourneyPricePeriod").click(function(event){
                    event.preventDefault();
                    var id = $(this).attr('rel');
                    var leftPanel=$(this).parent().parent().parent().parent().parent().parent().parent();
                    var rightPanel=leftPanel.parent().find(".rightPanel");
                ...
                $(".btnDeleteTJourneyPricePeriod").click(function(event){
                    event.preventDefault();
                    var id = $(this).attr('rel');
...
//                                            createSysAct('TJourneyPricePeriod', 'Delete', 2, result);
//                                            $("#dialog").html('<p><span class="ui-icon ui-icon-info" style="float:left; margin:0 7px 20px 0;"></span><?php echo MESSAGE_PROBLEM; ?></p>');
//                                        }else {
//                                            createSysAct('TJourneyPricePeriod', 'Delete', 1, '');
                                            // alert message
...
//                                        }
        ...
        $(".btnAddTJourneyPricePeriod").click(function(event){
            event.preventDefault();
...
<div class="leftPanel">
    ...
    <div style="padding: 5px;border: 1px dashed #bbbbbb;">
        <div class="buttons">
            <a href="" class="positive btnAddTJourneyPricePeriod">
                <img src="<?php echo $this->webroot; ?>img/button/plus.png" alt=""/>
                <?php echo MENU_SET_PRICE_PERIOD_ADD; ?>
            </a>
        </div>
        ...
        <table id="<?php echo $tblName; ?>" class="table" cellspacing="0">
            <thead>
                <tr>
                    ...
                    <th><?php echo MENU_TRANSPORTATION_TYPE; ?></th>
