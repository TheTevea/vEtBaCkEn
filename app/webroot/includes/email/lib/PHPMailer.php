...
class PHPMailer
{
    ...
    public static function isValidHost($host)
    {
        ...
        // if (filter_var('http://' . $host, FILTER_VALIDATE_URL, FILTER_FLAG_HOST_REQUIRED)) { // Support PHP version <= 5.6
        if (filter_var('http://' . $host, FILTER_VALIDATE_URL)) { // Support PHP version >= 7
